...
export function ProductStockStatus({ stock, reservations }: { stock: any, reservations: any[] }) {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <article className={"panel readiness-card " + (stock.quantity_available > 0 ? 'done' : 'danger')} style={{ margin: 0 }}>
          <FiCheck />
          <div>
