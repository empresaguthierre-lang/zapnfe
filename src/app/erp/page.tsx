...
export default async function ErpDashboardPage({ searchParams }: { searchParams: Promise<{ modulo?: string }> }) {
  ...
  return <AppShell active="erp" eyebrow="Gestão integrada" title="Painel ERP" actions={<Link className="primary-button" href="/erp/produtos/novo">Novo produto</Link>}>
    ...
    <section className="erp-roadmap panel"><div><p className="eyebrow">Primeiro núcleo</p><h3>ERP modular + automação ZapNFe</h3></div><ol><li className="done">Cadastros e organização</li><li className="done">Livro e saldos de estoque</li><li>Compras e fornecedores</li><li>Financeiro e fiscal</li></ol></section>
  </AppShell>;
}
