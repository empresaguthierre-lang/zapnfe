...
export default function DataDeletionPage() {
  return <LegalPage title="Solicitação de Dados e Exclusão" updatedAt="25 de agosto de 2026">
    ...
    <h2>Meta</h2><p>Desconectar o WhatsApp interrompe novas operações, mas não substitui uma solicitação formal de exclusão dos dados já tratados no Bridge ERP.</p>
  </LegalPage>;
}
