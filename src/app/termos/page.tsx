...
export default function TermsPage() {
  return <LegalPage title="Termos de Uso" updatedAt="25 de agosto de 2026">
    ...
    <h2>Inteligência artificial</h2><p>A extração automática pode conter erros. Todo pedido permanece em conferência humana até aprovação. O ZapNFe não deve emitir NF-e automaticamente com base exclusiva na interpretação da IA.</p>
