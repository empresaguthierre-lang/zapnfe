...
export default function PrivacyPage() {
  return <LegalPage title="Aviso de Privacidade" updatedAt="25 de agosto de 2026">
    <p>O ZapNFe trata dados necessários para transformar mensagens comerciais em pedidos estruturados e documentos fiscais. A versão definitiva deste aviso deverá identificar a pessoa jurídica operadora do ZapNFe, seu CNPJ, endereço e encarregado antes da ativação pública.</p>
